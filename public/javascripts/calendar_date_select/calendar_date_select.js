...
Date.months = $w("Jan Feb Mar Apr May Jun July Aug Sep Oct Nov Dec");
...
.bindAsEventListener(this)
    ...
    clearDate: function(){
        if ((this.target_element.disabled || this.target_element.readOnly) && this.options.get("popup") != "force") 
            return false;
    ...
    updateSelectedDate: function(partsOrElement, via_click){
        ...
        if (parts.get("hour") === "" || parts.get("minute") === "") 
            ...
            if (!isNaN(parts.get("hour")) || !isNaN(parts.get("minute"))) 
